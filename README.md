...
| [Dependency Chain Analysis of ROS 2 DDS QoS Policies: From Lifecycle Tutorial to Static Verification](https://doi.org/10.1109/JIOT.2026.3728458) | IEEE Internet of Things Journal, 2026 · early access | [QoS Guard](https://github.com/csi-dgist/QoS-Guard) · [Documentation](https://csi-dgist.github.io/QoS-Guard/) |
| [Optimizing ROS 2 Communication for Wireless Robotic Systems](https://arxiv.org/abs/2508.11366) | IEEE VTC2027-Spring · under review | [DDS Optimizer](https://github.com/csi-dgist/DDS-Optimizer-for-Wireless-Large-Payload-Transfer) · [Paper](https://arxiv.org/abs/2508.11366) |
